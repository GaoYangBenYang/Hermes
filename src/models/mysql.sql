...
CREATE TABLE user (
  ...
  updated_time DATETIME COMMENT "用户更新时间，可为空"
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='粉丝表'COMMENT "问题表";

CREATE TABLE tag (
id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, -- 标签ID，主键，自增长
name VARCHAR(50) UNIQUE NOT NULL -- 标签名称，唯一，不为空
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='粉丝表' COMMENT "标签表";
...
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='粉丝表' COMMENT "问题-标签关联表";
...
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='粉丝表' COMMENT "回答表" ;
...
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='粉丝表'COMMENT"评论模块";
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='粉丝表'COMMENT "通知表";
